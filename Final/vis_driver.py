...
def generate_all_vis(directory='./test/sample2/', magic_number = 4, upper_column_constraint=10):
    ...
    for graph_id in range(0, upper_column_constraint):
        ...
        return_list.append([graph_value, "table", data.columns[graph_id]])
